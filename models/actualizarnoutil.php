...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $updateQuery = "UPDATE resenias_peliculas SET cant_no_util = $cantidad WHERE resenia_id = $id";
    ...
    if ($conn->query($updateQuery) === TRUE) {
        ...
        $updateQuery = "UPDATE resenias_series SET cant_no_util = $cantidad WHERE resenia_id = $id";
